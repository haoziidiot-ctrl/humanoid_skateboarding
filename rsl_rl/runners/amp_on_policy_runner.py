...
class AMPOnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        amp_loader_classes = {
            "G1_AMPLoader": G1_AMPLoader,
            "G1SimpleAMPLoader": G1SimpleAMPLoader,
        }
        amp_loader_class_name = train_cfg.get("amp_loader_class", "G1_AMPLoader")
        if amp_loader_class_name not in amp_loader_classes:
            raise ValueError(f"Unknown AMP loader class: {amp_loader_class_name}")
        amp_loader_class = amp_loader_classes[amp_loader_class_name]

        self.amp_data = amp_loader_class(
            device,
